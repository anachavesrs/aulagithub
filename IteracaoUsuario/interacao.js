function interacao() {
    ...
    if(media >= 7) 
        if(media >= 9)
    window.alert('Uau, você foi aprovado com louvor! A sua média é: ' + media); 
    else
    window.alert('Parabéns, aprovado! A sua média é: ' + media);    
    else 
    window.alert('Puxa, você precisa estudar mais. Está reprovado! A sua média é: ' + media );  
    }
